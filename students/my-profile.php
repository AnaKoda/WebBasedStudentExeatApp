<?php
    ...
    $sql="update tblstudents set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,House=:house,Address=:address,City=:city,Region=:region,Phonenumber=:mobileno where EmailId=:eid";
...
<head>
    ...
    <title>Student Exeat Management System</title>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="exeat.php"><img src="" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="#">
                                <a href="exeat.php" aria-expanded="true"><i class="ti-user"></i><span>Apply Exeat
                                    </span></a>
                            </li>

                            <li class="#">
                                <a href="exeat-history.php" aria-expanded="true"><i class="ti-agenda"></i><span>View My Exeat History
                                    </span></a>
                            </li>
        ...
        <div class="main-content">
            ...
            <div class="page-title-area">
                <div class="row align-items-center">
                    ...
                    <?php include '../includes/student-profile-section.php'?>
            ...
            <div class="main-content-inner">
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label for="example-text-input" class="col-form-label">Index Number</label>
                                <input class="form-control" name="stdcode" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->StdId);?>" id="example-text-input">
                            </div>

                            <div class="form-group">
                                <label for="example-text-input" class="col-form-label">Region</label>
                                <input class="form-control" name="region" type="text"  value="<?php echo htmlentities($result->Region);?>" autocomplete="off" required id="example-text-input">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="city" type="text"  value="<?php echo htmlentities($result->City);?>" autocomplete="off" required>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Selected House/Hall</label>
                                            <select class="custom-select" name="house" autocomplete="off">
                                            <option value="<?php echo htmlentities($result->House);?>"><?php echo htmlentities($result->House);?></option>

                                            <?php $sql = "SELECT HouseName from tblhouses";
                                                $query = $dbh -> prepare($sql);
                                                $query->execute();
                                                $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                $cnt=1;
                                                ...
                                                {   
                                            ?>  
                                                <option value="<?php echo htmlentities($resultt->HouseName);?>"><?php echo htmlentities($resultt->HouseName);?></option>
                                        <?php }} ?>
                                        </select>
                                        </div>
