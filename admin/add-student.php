...
function valid() {
if (document.addstd.password.value != document.addstd.confirmpassword.value) {
alert("New Password and Confirm Password Field do not match  !!");
document.addstd.confirmpassword.focus();
return false;
}
return true;
}
...
<script>
function checkAvailabilityStdid() {
$("#loaderIcon").show();
jQuery.ajax({
url: "check_availability.php",
data: 'stdcode=' + $("#stdcode").val(),
type: "POST",
success: function(data) {
$("#stdid-availability").html(data);
$("#loaderIcon").hide();
},
error: function() {}
});
...
<div class="card">
<form name="addstd" method="POST" enctype="multipart/form-data">
...
<input class="form-control" name="stdcode" type="text" autocomplete="off" required id="stdcode" onBlur="checkAvailabilityStdid()">
</div>
...
<div class="form-group">
<label class="col-form-label">House/Hall</label>
...
<option value="<?php echo htmlentities($result->HouseName); ?>"><?php echo htmlentities($result->HouseName); ?></option>
<?php }
} ?>
</select>
</div>
...
<input class="form-control" name="region" type="text" autocomplete="off" required id="example-text-input">
</div>
...
<h4>Set Password for Student Login</h4>
