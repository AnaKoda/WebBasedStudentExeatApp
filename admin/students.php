...
<button class="btn-success btn btn-md float-left"  onclick="window.print()">Print Report</button>
<center><a href="add-student.php" class="btn btn-sm btn-info float-right mb-3">Add New Student</a></center>
...
<?php } else { ?>
    ...
    <a href="students.php?del=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash" style="color:red"></i></a>
