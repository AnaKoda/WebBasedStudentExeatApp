<?php
    ...
    $sql="UPDATE tblstudents set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,House=:house,Address=:address,City=:city,Region=:region,Phonenumber=:mobileno where id=:eid";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Update Exeat Section</h4>
