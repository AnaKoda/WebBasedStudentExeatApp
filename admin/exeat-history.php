...
<h4 class="page-title pull-left">Exeats History</h4>
...
<td>Applied On</td>
 <td>Start Date</td>
 <td>End Date</td>
<td style="color:red">Overtsayed</td>
...
$sql = "SELECT tblexeats.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.StdId,tblstudents.id,tblexeats.ExeatType,tblexeats.PostingDate, tblexeats.FromDate,tblexeats.ToDate,tblexeats.Status from tblexeats join tblstudents on tblexeats.stdid=tblstudents.id order by lid desc";
...
<td style="color:red">
    ...
    //$datetime2=date_create($result->ToDate);

    //$overstay=date_diff($datetime2,$datetime1);
...
<div class="studentImage" style="width: 3rem; height:auto; border:1px solid red;">
