                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Declined Exeats</h4>
                                    ...
                                    <span aria-hidden="true">&times;</span>
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    $status=2;
                                                    $sql = "SELECT tblexeats.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.StdId,tblstudents.id,tblexeats.ExeatType,tblexeats.PostingDate,tblexeats.Status from tblexeats join tblexeats on tblexeats.stdid=tblstudents.id where tblexeats.Status=:status order by lid desc";
