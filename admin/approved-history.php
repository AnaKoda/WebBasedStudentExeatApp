                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Approved Exeats</h4>
                                ...
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                        ...
                                        <?php 
                                            $status=1;
                                            $sql = "SELECT tblexeats.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.StdId,tblstudents.id,tblexeats.ExeatType,tblexeats.PostingDate,tblexeats.Status from tblexeats join tblstudents on tblexeats.stdid=tblstudents.id where tblexeats.Status=:status order by lid desc";
