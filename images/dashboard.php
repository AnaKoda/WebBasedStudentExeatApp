...
<h1> <font color="black">  
 ...
 <h3> WELCOME TO  ADANWOMASE  SENIOR  HIGH SCHOOL  </h3>
</marquee>    
</font></h1> 
...
<div class="logo">
<a href="dashboard.php"><img src="images/ac.jpeg" alt="logo"></a>
</div>
</div>
<div class="main-menu">
...
<img class="avatar user-thumb" src="images/ac.jpeg" alt="avatar">
...
<div class="p-1">
<h4 class="header-title mb-0  text-white">Available Exeat Types</h4>
</div>
...
<!-- <a href="registered.php" class="small-box-footer">View Details <i class="fas fa-arrow-circle-right"></i></a> -->
</div>
</div>
...
<div class="p-2">
<h4 class="header-title mb-0 text-white">Number Of Students</h4>
</div>
...
<div class="p-2">
<h4 class="header-title mb-0  text-white">Avaliable Houses/Halls</h4>
</div>
...
<div class="p-2">
<h4 class="header-title mb-0 text-white">Pending Exeat Application</h4>
</div>
...
<div class="p-2">
<h4 class="header-title mb-0  text-white">Declined Exeat Application</h4>
...
<div class="p-2">
<h4 class="header-title mb-0  text-white">Approved Exeat Application</h4>
    ...
    if($result->ToDate >$result->FromDate){
        ...
        echo "Not Due";
             ...
             ?> </td>
                            ...
                            <td><a href="studentexeat-details.php?exeatid=<?php echo htmlentities($result->lid); ?>" class="btn btn-dark btn-sm">View Details</a></td>
                        </tr>
                <?php $cnt++;
                    }
                } ?>
