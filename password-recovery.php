<?php
    ...
    $stdpid=$_SESSION['stdid'];

    $con="UPDATE tblstudents set Password=:newpassword where id=:stdid";
    $chngpwd1 = $dbh->prepare($con);
    $chngpwd1-> bindParam(':stdid', $stdid, PDO::PARAM_STR);
            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        ...
                        <p>Please provide your student details for recovery.</p>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Index Number</label>
                            <input type="text" id="exampleInputPassword1" name="stdid" autocomplete="off">
                ...
                $empid=$_POST['stdid'];
                $email=$_POST['emailid'];
                $sql ="SELECT id FROM tblstudents WHERE EmailId=:email and StdId=:stdid";
