<?php
    ...
    if(isset($_POST['signin']))
    {
            ...
            if($status==0)
        {
            ...
            echo "<script type='text/javascript'> document.location = 'students/exeat.php'; </script>";
        }
            }   else  {
    ...
    <div class="login-area login-s2">
        <div class="container-fluid section-login">
            <div class="login-box ptb--100">
                <form method="POST" name="signin" class="bg-dark">
                    <div class="login-form-head">
                        <h4 class="text-white">Student Login Panel</h4>
                        <p class="text-white">Student Exeat Management System</p>
